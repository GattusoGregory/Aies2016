...
<div class='data' style='
   ...
   font-weight: bold;
    border-style: outset;
    border-width: 2px;
   '><?php echo 'Date : '.\$date1.'<br> Temperature : '.\$temp.'°C <br>Activité :<br> Rpi1 : '.\$presence_rpi1.'<br> Rpi2 : '. \$presence_rpi2.'<br> Rpi3 : '. \$presence_rpi3.'<br> Rpi4 : '. \$presence_rpi4.'<br> Rpi5 : '. \$presence_rpi5;?></div><?php
